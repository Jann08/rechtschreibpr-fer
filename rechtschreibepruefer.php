...
{
    // Text in Wörter und alles in kleinbuchstaben
...
// Rechtschreibprüfung in Schleife
while (true) {
    echo "Text eingeben oder exit: ";
    ...
    echo empty($falsch) ? "Text korrekt!\n" : "Falsche wörter: " . implode(", ", $falsch) . "\n";
}
